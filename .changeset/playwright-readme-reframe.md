...
README reframe: lead the npm landing page with the defensible differentiator.
...
The reframe leads instead with the combination that *is* specific to tracelane:
