...
// assert tools/list returns the documented peek tool surface (16:
// 8 read + get_page_view + get_element_detail + 2 act + 2 suggest + 1 handoff + 1 set_intent). This is the closest thing to how an
