...
export function writeReport(input: WriteReportInput): string {
  ...
  const buildOptions: BuildReportOptions = {};
  if (footer === false) buildOptions.footer = false;
  if (security !== undefined) buildOptions.security = security;
  if (securitySuppress !== undefined) buildOptions.securitySuppress = securitySuppress;
